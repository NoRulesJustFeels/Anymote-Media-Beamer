...
/**
 * Custom HTTP server to send video file to Google TV device media player; support range requests
...
//			    Log.log(Level.CONFIG, "  HDR: '" + value + "' = '" +
...
//			{
//			    String value = (String)e.nextElement();
//			    Log.log(Level.CONFIG, "  PRM: '" + value + "' = '" +
...
//			{
//			    String value = (String)e.nextElement();
//			    Log.log(Level.CONFIG, "  UPLOADED: '" + value + "' = '" +
